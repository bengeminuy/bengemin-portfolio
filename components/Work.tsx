        ...
        <div className="portrait:px-[1.5rem] pt-6 max-w-3xl">
          <ol className="relative border-s border-gray-200">
            <li className="ms-4 pt-8 pb-8">
              ...
              <h2 className="pb-2 text-2xl font-bold leading-none text-white">
                <span className="purple-gradient-overlay">
                  {"Nipponware Dinnerware"}
                </span>
              </h2>
              <h3 className="text-lg italic font-semibold text-white/80">
                Fullstack Developer
              </h3>
              <h3 className="pb-2 text-md font-extralight text-white/70">
                01/2024 - Present
              </h3>
            ...
            <li className="ms-4 pb-8">
              ...
              <ul className="pb-8 space-y-1 list-disc list-inside text-white">
                <li>
