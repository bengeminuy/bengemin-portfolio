  ...
  return (
    <div className="flex h-8 gap-4">
      <a
        ...
        className="font-main cursor-pointer text-xl text-zinc-900 hover:text-zinc-500 fill-sky-200 hover:!fill-sky-300 h-full aspect-square pt-[1.5px]"
        aria-label="LinkedIn link"
        href="https://www.linkedin.com/in/bengeminuy/"
      >
        <svg
          width="14"
          height="14"
      ...
      <a
        target="_blank"
        rel="noopener noreferrer"
        className="font-main cursor-pointer text-xl text-zinc-900 hover:text-zinc-500 fill-rose-300 hover:!fill-rose-400 h-full aspect-square"
        aria-label="Resume link"
        href="/Fullstack Developer_John Bengemin Uy.pdf"
      >
        <svg
          className="svg-icon w-full h-full pt-[1px]"
      ...
      <a
        target="_blank"
        rel="noopener noreferrer"
        className="font-main cursor-pointer text-xl text-zinc-900 hover:text-zinc-500 fill-orange-300 hover:!fill-orange-400 h-full aspect-square"
        aria-label="Email link"
        href="mailto:bengemin.work@gmail.com"
      >
        <svg
          width="14"
          height="14"
          viewBox="0 0 14 14"
          xmlns="http://www.w3.org/2000/svg"
          className="w-full h-full pt-[1px]"
        >
