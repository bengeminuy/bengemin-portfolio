...
export default function DesktopWork() {
  return (
    <div className="hidden md:flex relative container mx-auto px-6 flex-col space-y-8 overflow-y-auto scrollable-div">
      <div className="opacity-0 md:opacity-100 absolute z-0 w-2 h-full bg-custom_accent2 shadow-md inset-0 left-17 md:mx-auto md:right-0 md:left-0 lg:h-[2320px] xl:h-[1680px] 2xl:h-[1420px]"></div>
          ...
          <div className="bg-custom_accent2 p-6 rounded-md shadow-md">
            ...
            <ul className="pt-1 text-justify list-disc pl-8">
              <li>
                ...
                data while also linking it to the database for Microlines as per
                the request from both Microlines and Streamline.
              </li>
              <li>
          ...
          <div className="bg-custom_accent2 p-6 rounded-md shadow-md">
            ...
            <ul className="pt-1 text-justify list-disc pl-8">
              <li>
                ...
                for customer use, digitalizing and automating various processes
                in their business.
              </li>
              <li>
              ...
              <li>
                ...
                single user type how to use the respective webapp and mobile app
                with regards to all supported business processes.
              </li>
            </ul>
          </div>
        </div>
