...
export default function Projects() {
  return (
    <main className="flex flex-col gap-1 pt-28 2xl:pt-32 items-center h-screen">
      <h1 className="text-xl xl:text-6xl 2xl:text-8xl leading-normal font-bold w-max opacity-80 xl:mb-6 2xl:mb-8">
        PROJECTS
      ...
      <div className="flex flex-wrap justify-center items-center px-4 w-full portrait:w-full gap-2 xl:gap-4 2xl:gap-8 2xl:text-2xl xl:text-l portrait:pb-4 portrait:overflow-y-auto scrollable-div">
          ...
          <figure className="relative object-cover rounded-xl overflow-hidden">
            ...
            <figcaption className="absolute left-0 bottom-0 h-full flex flex-col justify-between align-middle text-center break-normal bg-custom_accent2 p-2 xl:p-6 2xl:p-8 opacity-0 ease-in-out hover:opacity-100 duration-500">
              <h1 className="text-md xl:text-xl 2xl:text-2xl  text-left">
                ...
                automating all reports for Streamline and its sister companies.
              </h1>
              <h2 className="text-sm xl:text-md 2xl:text-lg text-right">
                @2022
              </h2>
        ...
        <div className="w-[250px] xl:w-[350px] 2xl:w-[400px] aspect-[4/3] rounded-xl shadow z-10 overflow-hidden">
          <figure className="relative object-cover rounded-xl overflow-hidden">
            ...
            <figcaption className="absolute left-0 bottom-0 h-full flex flex-col justify-between align-middle text-center break-normal bg-custom_accent2 p-2 xl:p-6 2xl:p-8 opacity-0 ease-in-out hover:opacity-100 duration-500">
              <h1 className="text-md xl:text-xl 2xl:text-2xl  text-left">
                NextJS based webapp using Firebase permitting church leaders to
                view and encode all personal and baptismal records online.
              </h1>
              <h2 className="text-sm xl:text-md 2xl:text-lg text-right">
                @2023
              </h2>
